...
def test_log_keyword_collision(tmp_path: Path):
    ...
    from latexify.pipeline.aggregator import _log_event, run_aggregator
    ...
    run_aggregator(tmp_path / "plan.json", snippets, out_dir, no_compile=True, simulate=True, assets_dir=None)
