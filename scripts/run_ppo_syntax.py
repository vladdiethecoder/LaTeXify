#!/usr/bin/env python3
"""Lightweight PPO loop that optimizes syntax reward using the latexify.pipeline."""
...
from latexify.scripts.pdf_render import available_templates, render_prompt_to_pdf
