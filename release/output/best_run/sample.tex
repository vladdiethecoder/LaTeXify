...
\RightarrowInverse is not a function
...
\RightarrowInverse is a function
...
6
b) g(x) = f(x + 1) -3
The d = -1 (since x -d = x -(-1)) indicates a horizontal translation of 1 unit to the left and the c = -3 indicates a vertical translation of 3 units down.
x' = x
1 + (-1)
= 0
= 1(-2) + (-3)
...
7
d) g(x) = -f(-x -1) + 3
The a = -1 indicates a reflection in the x-axis, the k = -1 indicates a reflection in the y-axis, the d = -1 (from x -d = x -(-1)) indicates a horizontal translation of 1 unit to the left, and the c = 3 indicates a vertical translation of 3 units up.
k + d
= 1
-1 + (-1)
= -2
